setwd("C:\\Users\\Zach\\Desktop\\R Stuff\\Fasta Resampler\\CR")
library(seqinr)
...
#SO here's the part that you care about! The first number there is the number of resamples. It'll make new fasta files into your working directory folder!
...
replicate(501, shuffleAndExtract("CB_Shorter Sequences_Contemporary Only.fas", 400, 550)) #replicate(resamples, shuffleAndExtract("yourfile.fas", number of sequences resampled, length of sequence))

replicate(501, shuffleAndExtract("CR_All Contemporary.fas", 400, 333)) #replicate(resamples, shuffleAndExtract("yourfile.fas", number of sequences resampled, length of sequence))