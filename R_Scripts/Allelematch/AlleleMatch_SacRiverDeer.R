...
data = as.data.frame(read.table("SacRiverDeer4Allelematch.txt", header = T, sep = "\t")) #Reads file.txt as the focal dataset
...
amCSV.amUnique(unique, "outputAllelematch_SacRiverDeer.csv")