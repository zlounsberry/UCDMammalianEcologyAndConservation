setwd("V:/3730Data/377STRs/Wildlife/R Scripts") #This makes the current folder (R Scripts in the Wildlife folder) the working directory
...
DNA = read.dna("Sarah1.fas", format = "fasta") #This makes your fasta file an object (specifically a matrix) in R to be played with
...
write.dna(DNA1, "Sarah2.fas", format = "fasta", append = FALSE, nbcol = -1, colsep = "", colw = 10, indent = NULL, blocksep = 1)
