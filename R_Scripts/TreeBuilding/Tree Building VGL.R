...
setwd("C:/Users/AwesomeZach/Desktop/R Folder") #sets your working directory
library(phangorn) #loads phangorn
library(ape) #loads ape
DNA = read.phyDat("YourFile.fas", format = "fasta", type = "DNA") #turns YourFile.fas from your wd into an object 'DNA', class phyDat
...
par(mar=c(.1,.1,.1,.1)) #this just optimizes your graphics window... You can plot multiple trees together, etc. using this
