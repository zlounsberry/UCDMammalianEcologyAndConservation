...
par(mar=c(1,1,1,5), mfrow=c(2,1), xpd=T) #this just optimizes your graphics window... You can plot multiple trees together, etc. using this
root = root(fit1$tree, 9)
plotBS(root, bs, bs.adj = c(1.1,1), type="phylogram", cex=2, bs.col="gray80", font = 1, use.edge.length = T, edge.color="black", tip.color="black", label.offset = 0.001, root.edge=T)
