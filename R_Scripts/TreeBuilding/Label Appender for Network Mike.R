setwd("V:/3730Data/377STRs/Wildlife/R Scripts/R Stuff/TreeBuilding") #This makes the current folder (R Scripts in the Wildlife folder) the working directory
...
DNA = read.dna("Mike1.fasta", format = "fasta") #This makes your fasta file an object (specifically a matrix) in R to be played with
...
DNA1 = makeLabel(DNA, len = 5, space = " ", make.unique = TRUE, illegal = "():;,[]-", quote = FALSE)
...
write.dna(DNA1, "Mike2.fas", format = "fasta", append = FALSE, nbcol = -1, colsep = "", colw = 10, indent = NULL, blocksep = 1)
...
#First, read your file (you can use your new one like I did, here... Or the original YourFile.fas... Or any .fas file) and make an
	#object, DNA2.
DNA2 = read.dna("Sarah1.fas", format = "fasta")
...
write.dna(DNA2, "Sarah2.fas", format = "fasta", append = FALSE, nbcol = -1, colsep = "", colw = 10, indent = NULL, blocksep = 1)
