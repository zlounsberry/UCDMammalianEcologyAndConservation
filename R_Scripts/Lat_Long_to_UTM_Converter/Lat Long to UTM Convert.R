...
xy = read.table("V:/3730Data/377STRs/Wildlife/DeerMendocinoStudy/ZL-Deer Mendocino/Deer - Zach's Desktop/Geneland/Deer 2011 Coords Geneland UTM.txt", row.names = NULL)
