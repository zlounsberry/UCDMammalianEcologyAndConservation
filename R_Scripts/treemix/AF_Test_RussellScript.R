setwd("V:/3730Data/377STRs/Wildlife/R Scripts/R Stuff/treemix/AF_Test_RussellScript")
...
#k=1
plot_tree("TreeMix", "pop_order_test3")
title("432.707")
plot_tree("TreemixMissingDataOut_1.79", "pop_order_test3")
title("429.004")
plot_tree("TreemixMissingDataOut_1.63", "pop_order_test3")
title("424.306")
plot_tree("TreemixMissingDataOut_1.15", "pop_order_test3")
title("423.043")
plot_tree("TreemixMissingDataOut_1.42", "pop_order_test3")
title("421.173")
plot_tree("TreemixMissingDataOut_1.8", "pop_order_test3")
title("409.067")
plot_tree("TreemixMissingDataOut_1.67", "pop_order_test3")
title("382.866")


#k=5
plot_tree("TreemixMissingDataOut_5.2", "pop_order_test3")
title("429.199")
plot_tree("TreemixMissingDataOut_5.57", "pop_order_test3")
title("428.929")
plot_tree("TreemixMissingDataOut_5.8", "pop_order_test3")
title("425.344")
plot_tree("TreemixMissingDataOut_5.92", "pop_order_test3")
title("425.236")
plot_tree("TreemixMissingDataOut_5.52", "pop_order_test3")
title("423.73")
plot_tree("TreemixMissingDataOut_5.99", "pop_order_test3")
title("401.305")
plot_tree("TreemixMissingDataOut_5.63", "pop_order_test3")
title("362.42")



#Rooted with Wolf (for pub with bootstrap points in red)
	#NOTE: I went into the files "*.edges.gz" and removed the line that said "MIG" so that the migration lines would go away... Might not have been the best way to do it...
plot_tree("TreemixMissingDataOut.wolf.50", "pop_order_test3", cex=1.5, lwd=2, font=2)
points(0.04645,0.845, cex=1.75, pch=21, bg="red")
points(0.0507,0.768, cex=1.75, pch=21, bg="red")
points(0.05415,0.693, cex=1.75, pch=21, bg="red")
points(0.05084,0.54, cex=1.75, pch=21, bg="red")
points(0.07165,0.456, cex=1.75, pch=21, bg="red")
points(0.0322,0.615, cex=1.75, pch=21, bg="red")

rect(-0.01,0.1,0.02,0.7, col="white", border=NA)
plot_resid("TreemixMissingDataOut.wolf.50", "pop_order_test3", cex=1.1)



plot_tree("TreemixMissingDataOut.wolf.24", "pop_order_test3")
plot_resid("TreemixMissingDataOut.wolf.24", "pop_order_test3")

plot_tree("TreemixMissingDataOut.wolf.11", "pop_order_test3")
plot_resid("TreemixMissingDataOut.wolf.11", "pop_order_test3")

plot_tree("TreemixMissingDataOut.wolf.69", "pop_order_test3")
plot_resid("TreemixMissingDataOut.wolf.69", "pop_order_test3")

plot_tree("TreemixMissingDataOut.wolf.100", "pop_order_test3")
plot_resid("TreemixMissingDataOut.wolf.100", "pop_order_test3")