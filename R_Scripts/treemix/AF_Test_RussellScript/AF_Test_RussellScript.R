...
dev.off()
pdf(file="treemix.pdf", width=10, height=10)
plot.new()
par(xpd=T)
...
#k=1
plot_tree("17", "pop_order_test3")

plot_resid("17", "pop_order_test3")

plot_tree("75", "pop_order_test3")

plot_resid("75", "pop_order_test3")
