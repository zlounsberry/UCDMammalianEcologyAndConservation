setwd("V:/3730Data/377STRs/Wildlife/R Scripts/R Stuff/treemix/Coyote")
...
#No k
plot_tree("CoyHiSeq_NoK.5")
title("304")
plot_tree("CoyHiSeq_NoK.6")
title("288")
plot_tree("CoyHiSeq_NoK.7")
title("309")
plot_tree("CoyHiSeq_NoK.8")
title("285")

plot_tree("no-k/Canid.12", "pop_order_test3") #pop order test is used to color the tree...
