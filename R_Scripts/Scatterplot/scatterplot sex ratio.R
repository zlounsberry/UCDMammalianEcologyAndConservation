...
r = read.table("sex ratio props.txt", header = TRUE, row.names = NULL)
model = r$model
year = r$year
sex = r$sex
ratio = r$expected
...
title("Proportion of Each Sex Relative to Total Population", cex.main = 1.5)
legend(2012.3, 1, legend=c("Males","Females","Expected","Capwire","Huggins"), pch = c(16,15,21,21,21), pt.bg = c(NA,NA,"gray80","gray50","black"),  pt.cex = 2, cex = 1.1)
