...
data_full <- read.table("20161007_DeerTest.txt", header = T, sep = "\t")
...
#write.table(final, "20161007_DeerTest_out.txt", sep="\t", row.names=F)
...
write.table(all, "SacRiverDeer_All_Output.txt", sep="\t", row.names=F)
